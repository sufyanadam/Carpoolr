class AddPickupSpots < ActiveRecord::Migration
  def up
    ...
    PickupSpot.create!(:name => "Berkeley (NB BART)", :lat => 37.874245, :long => -122.282585)
    ...
    PickupSpot.create!(:name => "Fairfield Trns Cntr", :lat => 38.248501, :long => -122.069)
    PickupSpot.create!(:name => "Hercules Trns Cntr", :lat => 38.01334, :long => -122.272133)
    PickupSpot.create!(:name => "Lafayette BART", :lat => 37.893425, :long => -122.123795)
    PickupSpot.create!(:name => "Moraga Way", :lat => 37.836021, :long => -122.131409)
   ...
   #  PickupSpot.create!(:name => "Oakland (MacArthur & High)")
    PickupSpot.create!(:name => "Orinda BART", :lat => 37.878522, :long => -122.183005)
    PickupSpot.create!(:name => "Piedmont (Oakland Ave)", :lat => 37.825287, :long => -122.235672)
    PickupSpot.create!(:name => "Richmond Pkwy", :lat => 37.986526, :long => -122.31633)
    PickupSpot.create!(:name => "Vallejo (Curtola Pkwy)", :lat => 38.092869, :long => -122.237366)
